...
- React Router are used to switch between pages.
- Redux are for reading pieces of state and dispatching actions to update the information of the whole project. For example, when I add the product that I want to buy, the information in shopping cart will be updated as well by Redux.
- I use styled-component inside each react jsx file instead of css, because I realize style-componnet is more easier to manage projects with massive amount of pages.
